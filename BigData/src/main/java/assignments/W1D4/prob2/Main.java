...
public class Main {
	public static void main(String[] args) {
		WordCount wordCount = new WordCount(new String[] { "apple lemon mango salmon wheat apple",
				"barley salmon apple orange carrot rice", "mango carrot lemon apple rice tuna" }, 3);
		wordCount.run();
