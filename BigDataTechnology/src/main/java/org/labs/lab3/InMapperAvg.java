...
public class InMapperAvg extends Configured implements Tool {
	public static class Map extends Mapper<LongWritable, Text, IntWritable, IntPair> {
		...
		@Override
		protected void cleanup(Mapper<LongWritable, Text, IntWritable, IntPair>.Context context)
				throws IOException, InterruptedException {
			// TODO Auto-generated method stub
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new InMapperAvg(), args);
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(getConf(), "InMapperAvg");
		job.setJarByClass(InMapperAvg.class);
