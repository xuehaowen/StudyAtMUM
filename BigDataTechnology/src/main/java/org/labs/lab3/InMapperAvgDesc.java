...
public class InMapperAvgDesc extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new InMapperAvgDesc(), args);
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(getConf(), "InMapperAvgDesc");
		job.setJarByClass(InMapperAvgDesc.class);
